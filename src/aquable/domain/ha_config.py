...
class HAEntity:
    ...
    @classmethod
    def from_dict(cls, data: dict) -> 'HAEntity':
        return cls(**data)
...
class HAConfig:
    ...
    def from_dict(cls, data: dict) -> 'HAConfig':
        ...
        entities = [HAEntity.from_dict(e) if isinstance(e, dict) else e for e in entities_data]
...
_ha_storage: HAConfigStorage | None = None
